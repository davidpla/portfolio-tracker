...
export const ASSETS: Record<string, Asset> = {
  ...
  asset_4: { ticker: "TSLA", name: "Tesla", type: "stock" },
  asset_5: { ticker: "10YR", name: "10 Year Bond", type: "bond" },
  asset_6: { ticker: "20YR", name: "20 Year Bond", type: "bond" },
  asset_7: { ticker: "BAYC", name: "Bored Ape Yacht Club", type: "nft" },
  asset_8: { ticker: "SMB", name: "Solana Monkey Business", type: "nft" },
  asset_9: { ticker: "JOE", name: "Trader Joe", type: "defi" },
  asset_10: { ticker: "OHM", name: "Olympus", type: "defi" },
  asset_11: { ticker: "FUNDRISE", name: "Fundrise", type: "real_estate" },
  asset_12: { ticker: "CONCREIT", name: "Concreit", type: "real_estate" },
};